...
// We're creating a custom modal instead of using Aceternity's for better control
...
// Custom modal wrapper that integrates with Aceternity's modal system
const TradeModalWrapper = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-[95vw] h-[85vh] bg-black text-white rounded-lg border border-gray-800 overflow-hidden">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="flex h-full">
          ...
          <div className="w-2/3 flex flex-col">
            {/* Top Half - Order Book */}
            <div className="h-1/2 border-b border-gray-800 p-4">
