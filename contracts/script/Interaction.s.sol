...
contract InteractScript is Script {
    ...
    function run() external {
        ...
        TestERC20 underlying = TestERC20(0xb0f495A5156a162dE68F1ca4F1b2bb1Dbc6b935E);
        TestERC20 quote = TestERC20(0xFADeBc92aEAb2E5C076081489Ec6671bA290843d);

        underlying.mint(maker, 20 ether);
        quote.mint(buyer, 2_000_000 * (10 ** 6));
        // quote.mint(msg.sender, 10_000_000 * (10 ** 6));

        OptionNFT nft = OptionNFT(0x87C83A6835041016f9aE67eB6cA690Cd718C6B03);
        OptionEngine engine = OptionEngine(0xBBaf795Af286b56f5255E75c1271aD9a437fFf22);
        OptionHook hook = OptionHook(0x5fcf14BfDc1643CDc4e6e1103A4D402A279Aa2C2);

        LimitOrderProtocol limitOrderProtocol = LimitOrderProtocol(payable(0xEA4C65C75debD5Ce0F87BdDE8d55a0a57aC43088));
        ...
        MakerTraits makerTraits = MakerTraits.wrap((1 << 254) | (1 << 252) | (1 << 251) | (1 << 249));
        ...
        // console.log("Extension Bytes:", extension);
        uint256 extensionHash = uint256(keccak256(extension));
        console.log("ExtensionHash:", extensionHash);
